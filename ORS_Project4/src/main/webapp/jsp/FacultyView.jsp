			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="firstname"
						placeholder=" Enter First Name" style="width:210px"
				...
				<tr>
					...
					<td><input type="text" name="lastname"
						placeholder=" Enter last Name" style="width:210px"
				...
				<tr>
                    ...
                    <td><input type="text" name="dob" placeholder="Enter Date Of Birth" style="width:210px" readonly="readonly" id="date" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
    ...
    <tr><th style="padding: 2px"></th></tr>          
				...
				<tr>
					...
					<td><input type="text" name="loginid"
						placeholder=" Enter Login Id" style="width:210px"
				...
				<tr>
					...
					<td><input type="text" name="mobileno" style="width:210px"
