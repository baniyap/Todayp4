   ...
   <center>
    ...
    <div align="center">    
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="firstName" placeholder="Enter First Name" style="width:210px"  value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" name="lastName" placeholder="Enter Last Name" style="width:210px" value="<%=DataUtility.getStringData(bean.getLastName())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter EmailId" style="width:210px" value="<%=DataUtility.getStringData(bean.getLogin())%>"
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" placeholder="Enter Password" style="width:210px" value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirmPassword" placeholder="Re-Enter Password" style="width:210px" value="<%=DataUtility.getStringData(bean.getConfirmPassword())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" placeholder="Enter Date Of Birth" style="width:210px" readonly="readonly" id="udatee" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="number" style="width:210px" name="mobileNo" maxlength="10" placeholder="Enter Mobile No" size= "25" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
