			...
			<table>
				<tr>
					...
					<td><input type="text" name="firstName"
						placeholder="Enter First Name" style="width:204px"
				...
				<tr>
					...
					<td><input type="text" name="lastName"
						placeholder="Enter last Name" style="width:204px"
				...
				<tr>
					...
					<td><input type="text" name="login"
						placeholder="Enter valid Email-Id" style="width:204px"
				...
				<tr>
					...
					<td><input type="text" name="dob" id="udate"
						readonly="readonly" style="width:204px" placeholder="Enter Dob "
				...
				<tr>
					...
					<td><input type="text" name="mobileNo"
						placeholder="Enter Mobile No" style="width:204px" maxlength="10"
				...
				<tr>
					...
					<td><input type="password" name="password"
						placeholder="Enter Password" style="width:204px"
				...
				<tr>
					...
					<td><input type="password" name="confirmPassword"
						placeholder="Re-Enter password" style="width:204px"
