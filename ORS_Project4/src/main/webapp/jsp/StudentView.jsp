...
<body>
	  ...
	  <tr><th style="padding: 3px"></th></tr>    	
		...
		<td style="position: fixed"><font  color="red"><%=ServletUtility.getErrorMessage("lastname", request)%></font>
		 ...
		 <tr>
          ...
          <td><input type="text" name="dob" id="udate4" readonly="readonly" placeholder=" Date of Birth" style="width:210px"  value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 
   ...
   <tr><th style="padding: 3px"></th></tr>    
		...
		<td><input type="text" name="mobile" maxlength="10" placeholder="Enter Mobile No" style="width:210px" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
		...
		<td><input type="text" name="email" placeholder="Enter Email_Id" style="width:210px" value="<%=DataUtility.getStringData(bean.getEmail())%>"></td>
